                    ...
                    <AnimatedContent
                        ...
                        <div>
                            ...
                            <p className="text-center mt-3 text-[11px] text-gray-300 md:text-sm lg-text-sm">
                                A collection of web-based projects that demonstrate<br/>my skills in web3 and front end development in various web3 topics
                            </p>
                        </div>
                    </AnimatedContent>
                    <FadeContent
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mt-8 mb-10">
                            {[
                                { src: flux, title: "Flux SDK", link: "/Project/Flux" },
